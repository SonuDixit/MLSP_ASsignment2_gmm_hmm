...
em = EM_algo_GMM(data,num_gaussian=2,kind="full")
log_likelihood1,parametrs1,mix_coeff1 = em.EM_iteration(max_itr,kind="full")
with open("speech_class_35.pickle","wb") as f:
...
for i in range(1,len(alldata)):
    data = np.vstack((data,alldata[i]))
em = EM_algo_GMM(data,num_gaussian=2,kind="full")
log_likelihood2,parametrs2,mix_coeff2 = em.EM_iteration(max_itr,kind="full")
with open("music_class_35.pickle","wb") as f:
